...
import { 
  ...
  Phone, Mail, MapPin, User, Shield, Database, Minus,  // Add this for inventory modal
  Printer
} from 'lucide-react';
          ...
          {activeView === 'tables' && (
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                  <h2 className="text-xl lg:text-2xl font-bold text-gray-900">Table Management</h2>
                  <p className="text-gray-600 mt-1">Manage restaurant tables and seating</p>
                </div>
                <div className="flex flex-wrap gap-3">
                  <button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2.5 rounded-xl font-medium flex items-center space-x-2 transition">
                    <Plus className="w-4 h-4" />
                    <span>Add Table</span>
                  </button>
                  <button className="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2.5 rounded-xl font-medium flex items-center space-x-2 transition">
                    <Calendar className="w-4 h-4" />
                    ...
                    >
                      ...
                      <div className="w-12 h-12 mx-auto rounded-lg flex items-center justify-center mb-2">
                        <Utensils className={`w-6 h-6 ${
                          ...
                          table.status === 'reserved' ? 'text-purple-600' :
                          'text-emerald-600'
                        }`} />
                      </div>
